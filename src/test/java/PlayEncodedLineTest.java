...
public class PlayEncodedLineTest {
    ...
    public void test(){
        ...
        commandsFactory = new CommandsFactory(document,2);
        ...
        assertEquals(encodedContent.get(0).trim(),"Napvrag ehvaf".trim());
    ...
    public void test1(){
        ...
        assertEquals(encodedContent.get(0).trim(),"Zmxrvmg ifrmh".trim());
